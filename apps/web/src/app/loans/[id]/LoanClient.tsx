...
import { getLoan, returnItem, addItem, forceClose, deleteItem, type Loan, type LoanItem } from "@/lib/api";
...
const fetcher = (id: string) => getLoan(id); // getLoan: Promise<LoanWithItems>
